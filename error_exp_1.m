...
close all
%%
file_path1=('F:\HP\experiments\ScanError\error_rgb_2');
i_max = 120;
j_max = 1;
...
x0=[0;0;0];
ObjectiveFunction2 = @(x)mitest1(x,SCB1R,rgb2,nptc2,xlimit,ylimit);%Sib1R,SB1R,SN1R,SRB1R,Ref2,int2
[x,fval2,exitFlag2,output2] = patternsearch(ObjectiveFunction2,x0);
tf=x(3,1);
toc;
%%
